...
import com.adbtool.utils.ReUtils;
import com.adbtool.utils.ShellUtils;
...
//		}
	...
	public int getPid(String packageName) {
		...
		if (num.isEmpty()) {
			throw new TestException("应用包名不存在或者进程未启动...");
		}
	 ...
	 * 
	 * @param pid
	 *            进程的pid	 * @return 进程被杀死，返回true，否则返回false
	 */
	 ...
	 * 
	 * @param packageName
	 *            应用的包名	 * @return 已安装，返回true，否则返回false
	 */
	 ...
	 * 清除应用的用户数据	 * 
	 * @param packageName
	 *            应用的包名	 * @return 清楚成功返回true, 否则返回false
	 */
	 ...
	 * 
	 * @param x
	 *            x小于1，自动乘以分辨率转换为实际坐标，大于1，当做实际坐标处�?	 * @param y
	 *            y小于1，自动乘以分辨率转换为实际坐标，大于1，当做实际坐标处�?	 */
